        ...
        <div style={s.listContainer}>
          {scores.length === 0 ? (
            ...
            scores.map((entry, idx) => (
              <div key={idx} style={{ 
                ...s.scoreRow, 
                backgroundColor: idx === 0 ? 'rgba(255, 215, 0, 0.15)' : 'rgba(255, 255, 255, 0.05)', 
                borderColor: idx === 0 ? '#ffd700' : 'rgba(255, 255, 255, 0.1)' 
              }}>
...
const s: any = {
  ...
  container: { width: '100%', maxWidth: '450px', backgroundColor: '#1a1d2e', borderRadius: '30px', padding: '30px 20px', display: 'flex', flexDirection: 'column', maxHeight: '90vh', border: '1px solid rgba(255,215,0,0.3)', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' },
  header: { textAlign: 'center', marginBottom: '20px' },
  icon: { fontSize: '4rem', display: 'block', marginBottom: '10px' },
  title: { color: '#ffd700', fontSize: '2.5rem', fontWeight: '900', margin: '0 0 5px 0' },
  ...
  rank: { width: '40px', fontSize: '1.5rem', fontWeight: '900', color: '#ffd700' },
  ...
  score: { fontSize: '1.5rem', fontWeight: '900', color: '#10b981', textAlign: 'left' },
  pts: { fontSize: '0.8rem', color: '#64748b', marginRight: '3px' },
  closeBtn: { width: '100%', height: '60px', backgroundColor: '#ffd700', color: '#05081c', border: 'none', borderRadius: '15px', fontWeight: '900', fontSize: '1.3rem', cursor: 'pointer', flexShrink: 0, boxShadow: '0 4px 15px rgba(255,215,0,0.3)' }
};